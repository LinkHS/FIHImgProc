...
private:
	...
	void	TransmissionEstimationColor(cv::Mat &mSrc, float *pfTransmission,int *pnImageRP, int *pnImageGP, int *pnImageBP, float *pfTransmissionP,int nFrame, int nWid, int nHei);
    ...
    inline float myNFTrsEstimationColor(cv::Mat &mSrc, int nStartX, int nStartY, int nWid, int nHei);
    ...
    void    myGuidedFilter(cv::Mat &mGuide, int r, float fEps);
    void    myGuidedFilterGray(cv::Mat &mGuide, int r, float fEps);
